...
with tabs[0]:
    ...
    if img_file:
        ...
        # Gemini fetch scientific details
        prompt_details = (
        ...
        # Gemini analyze phenotypic stress
        prompt_stress = (
...
with tabs[1]:
    ...
    fig.update_layout(
        ...
        title_text="3D OLS Regression Surface with NLP Hover"
    )
